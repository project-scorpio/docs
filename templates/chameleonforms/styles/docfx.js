...
$(function () {
  ...
  function renderNavbar() {
    ...
    function loadNavbar() {
      ...
      $.get(navbarPath, function (data) {
        $(data).find("#navbar>ul").appendTo("#navbar");
        showSearch();
        ...
        $('#navbar>ul').addClass('navbar-nav flex-row ml-md-auto d-none d-md-flex');
  ...
  function renderSidebar() {
    var sidetoc = $('#sidetoggle #bd-docs-nav')[0];
    if (typeof (sidetoc) === 'undefined') {
      ...
      var top = 0;
      $('#bd-docs-nav a.active').parents('li').each(function (i, e) {
    ...
    function registerTocEvents() {
      ...
      tocFilterInput.on('input', function (e) {
        ...
        if (val === '') {
          ...
          $('#sidetoggle li,#sidetoggle div.bd-toc-item').removeClass(filtered).removeClass(hide);
        ...
        $('#sidetoggle div.bd-toc-item>a,#sidetoggle li>a').filter(function (i, e) {
    ...
    function loadToc() {
      ...
      $('#sidetoggle').load(tocPath + " #sidetoggle > *", function (responseTxt) {
        ...
        $('#sidetoggle').find('a[href]').each(function (i, e) {
          var href = $(e).attr("href");
          if (util.isRelativePath(href)) {
            href = tocrel + href;
            $(e).attr("href", href);
  ...
  function renderBreadcrumb() {
    ...
    $('#bd-docs-nav a.active').each(function (i, e) {
      breadcrumb.push({
        href: e.href,
        name: e.innerHTML
      });
  ...
  function renderAffix() {
    ...
    if (!hierarchy || hierarchy.length <= 0) {
      ...
      var html = util.formList(hierarchy, ['section-nav']);
    ...
    function getHierarchy() {
      ...
      var $headers = $($.map(['h1', 'h2', 'h3', 'h4'], function (h) { return "main.bd-content " + h; }).join(", "));
    ...
    function formList(item, classes) {
      ...
      function getList(model, cls) {
        ...
        for (var i = 0; i < l; i++) {
          ...
          var name = item.name;
          if (!name) continue;
          html += href ? '<li class="toc-entry toc-h'+(level)+'"><a href="' + href + '">' + name + '</a>' : '<li>' + name;
          html += getList(item) || '';
          html += '</li>';
        }
        html += '</ul>';
